...
function clientNav(slug: string): NavItem[] {
  return [
    ...
    { section: 'Facturation', label: 'Fournisseurs', href: `/${slug}/client/fournisseurs`, icon: Truck },
    { section: 'Facturation', label: 'Depenses', href: `/${slug}/client/depenses`, icon: HandCoins },
